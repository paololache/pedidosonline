...
const SAMPLE_PRODUCTS = [
  ...
  { id: '6', name: 'Pizza Suprema Familiar', description: '40cm. Pepperoni, champiñones, pimiento, cebolla, aceitunas', price: 46.00, category: 'Pizzas', image_url: `${IMG}/photo-1552539614-7ef6e6e4586e?w=400&h=400&fit=crop`, is_available: true, is_featured: true, sort_order: 6 },
  { id: '7', name: 'Alitas de Pollo BBQ', description: '6 alitas bañadas en salsa BBQ ahumada', price: 18.00, category: 'Entradas', image_url: `${IMG}/photo-1527477396000-e27163b4be70?w=400&h=400&fit=crop`, is_available: true, is_featured: false, sort_order: 10 },
  { id: '8', name: 'Pan de Ajo', description: 'Pan artesanal con mantequilla de ajo y hierbas', price: 10.00, category: 'Entradas', image_url: `${IMG}/photo-1619535860434-ba1d2fa2b5f3?w=400&h=400&fit=crop`, is_available: true, is_featured: false, sort_order: 11 },
  ...
  { id: '12', name: 'Inca Kola 500ml', description: 'Bebida refrescante', price: 5.00, category: 'Bebidas', image_url: `${IMG}/photo-1620743132721-a5b5d45e158f?w=400&h=400&fit=crop`, is_available: true, is_featured: false, sort_order: 21 },
  ...
  { id: '15', name: 'Combo Pizza + Gaseosa', description: '1 Pizza Personal + 1 Gaseosa 500ml a elección', price: 28.00, category: 'Combos', image_url: `${IMG}/photo-1544027993-37d075ecb2f5?w=400&h=400&fit=crop`, is_available: true, is_featured: true, sort_order: 30 },
